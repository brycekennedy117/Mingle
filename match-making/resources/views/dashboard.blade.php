            ...
            <div class="col-md-auto">
                <div class="card">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="card" style= "max-width:12rem">
                            <img class="card-img-top" src="https://pbs.twimg.com/profile_images/712016346775564289/ajnm_P3F_400x400.jpg" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Tony Stark</h5>
                                <p class="card-text">lead-in to.</p>
                            </div>
                            <div class="card-footer">
                                <a href="#" class="btn btn-primary">Like</a>
                                <a href="#" class="btn btn-danger">Next</a>
                        ...
                        <div class="card" style= "max-width:12rem">
                            <img class="card-img-top" src="https://pbs.twimg.com/profile_images/848019862068666371/tYz6Y4F6_400x400.jpg" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Pepper Stark</h5>
